...
const Activities = () => {
    return (
        <section className='pt-10 pb-14 bg-slate-50'>
            <h1 className=' text-2xl text-center font-bold pb-5'>Our Activities</h1>
            <div>
                <div className=' flex justify-center'>
                    <div className=' w-11/12 md:w-3/4 grid gap-3 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 '>
                        {
                            data.map((item) =>
                                <div key={item.id} className=' p-3 rounded-lg shadow-md bg-white  hover:transform hover:scale-105 duration-150 hover:bg-teal-100'>
                                    <div className=' flex flex-col justify-center items-center'>
                                        ...
                                        <h1 className='text-center font-semibold pt-2'>{item.title}</h1>
                                    </div>
                                </div>
                            )
                        }
